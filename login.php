      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger active" href="signup.php">Sign Up</a>
            </li>
            <li class="nav-item">
	...
	<div id="login" class="section wb">
		<div class="container">
			...
			<div class="col-lg-12 text-center">
									<div id="success"></div>
									<button id="sendMessageButton" class="sim-btn btn-new from-middle animated" type="submit">Login</button>
								</div>
			</form>					
			</div>
			</div>
